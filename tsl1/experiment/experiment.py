...
def _pre_experiment_routine(cfg: DictConfig):
    ...
    # override data_dir in tsl1 config
...
class Experiment:
    ...
    Hydra is an optional dependency of tsl1, to install it using pip:
    ...
    Args:
        ...
        pre_run_hooks (list): Ordered list of functions to call on
            :meth:`~tsl1.experiment.Experiment.run` before the :attr:`run_fn`.
    ...
    def __init__(self,
        ...
        # store config_dir in tsl1 config
    ...
    def log_config(self) -> None:
        ...
        :meth:`~tsl1.experiment.Experiment.run_dir`."""
