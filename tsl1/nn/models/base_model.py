...
class BaseModel(nn.Module):
    ...
    * the methods :meth:`~tsl1.nn.models.BaseModel.add_model_specific_args`
      and :meth:`~tsl1.nn.models.BaseModel.add_argparse_args` allow to
    ...
    * the method :meth:`~tsl1.nn.models.BaseModel.loss` can be used to compute a
      custom loss on the provided training target. Inference modules in tsl1 will
      call this method for the loss computation, if implemented in the model.

    * the method :meth:`~tsl1.nn.models.BaseModel.predict` can be used to define
    ...
    * the parameter :attr:`return_type` specifies which the return type of the
    ...
    def has_loss(self) -> bool:
        ...
        :meth:`~tsl1.nn.models.BaseModel.loss` method."""
        return self.loss.__qualname__.split('.')[0] != 'BaseModel'

    @property
    def has_predict(self) -> bool:
        """Returns :obj:`True` if the model has implemented the
        :meth:`~tsl1.nn.models.BaseModel.predict` method."""
    ...
    def get_model_signature(cls) -> dict:
        ...
        :class:`~tsl1.nn.models.BaseModel`'s :obj:`__init__` function."""
        return foo_signature(cls)

    @classmethod
    def get_forward_signature(cls) -> dict:
        """Get signature of the model's
        :meth:`~tsl1.nn.models.BaseModel.forward` function."""
    ...
    def model_excluded_args(cls) -> Set:
        ...
        :meth:`~tsl1.nn.models.BaseModel.add_model_specific_args`)."""
        return {
    ...
    def add_model_specific_args(cls, parser: ArgumentParser):
        ...
        :meth:`~tsl1.nn.models.BaseModel.model_excluded_args`."""
