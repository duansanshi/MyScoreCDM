...
class Dataset(object):
    """Base class for Datasets in tsl1.
    ...
    def get_connectivity(self,
        ...
        if 'sparse' in kwargs:
            ...
            warnings.warn("The argument 'sparse' is deprecated and will be "
                          "removed in future version of tsl1. Please use "
    ...
    def get_splitter(self,
                     ...
                     *args,
                     **kwargs) -> Splitter:
        """Returns the splitter for a :class:`~tsl1.data.SpatioTemporalDataset`.
        A :class:`~tsl1.data.preprocessing.Splitter` provides the splits of the
    ...
    def get_config(self) -> dict:
        """Returns the keywords arguments (as dict) for instantiating a
         :class:`~tsl1.data.SpatioTemporalDataset`."""
        raise NotImplementedError
