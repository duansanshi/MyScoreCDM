...
class StaticBatch(Data):
    r"""A batch of :class:`tsl1.data.Data` objects for multiple spatiotemporal
    graphs sharing the same topology.

    The batch object extends :class:`~tsl1.data.Data`, thus preserving
    ...
    Args:
        ...
        transform (Mapping, optional): Named mapping of
            :class:`~tsl1.data.preprocessing.Scaler` associated with entries in
    ...
    def from_data_list(cls, data_list: List[Data]):
        r"""Constructs a :class:`~tsl1.data.Batch` object from a Python list of
         :class:`~tsl1.data.Data` representing temporal signals on a static
         (shared) graph."""
    ...
    def index_select(self, idx: IndexSlice) -> List[Data]:
        r"""Creates a subset of :class:`~tsl1.data.Data` objects from specified
        indices :obj:`idx`.
    ...
    def to_data_list(self) -> List[Data]:
        r"""Reconstructs the list of :class:`~tsl1.data.Data` objects from the
        :class:`~tsl1.data.StaticBatch` object."""
...
class DisjointBatch(Batch):
    ...
    Inherits from :class:`tsl1.data.Data`. In addition, single graphs can be
    ...
    def from_data_list(cls,
        ...
        r"""Constructs a :class:`~tsl1.data.DisjointBatch` object from a list of
        :class:`~tsl1.data.Data` objects.
        ...
        Args:
            data_list (list): The list of :class:`tsl1.data.Data` objects.
