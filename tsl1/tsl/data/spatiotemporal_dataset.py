...
class SpatioTemporalDataset(Dataset, DataParsingMixin):
    ...
    :class:`~tsl1.datasets.prototypes.Dataset` and
    ...
    Args:
        ...
        input_map (BatchMap or dict, optional): Defines how data (i.e., the
            ...
            while values are :obj:`~tsl1.data.new.BatchMapItem`.
            (default: :obj:`None`)
        ...
        transform (callable, optional): A function/transform that takes in a
            :class:`tsl1.data.Data` object and returns a transformed version.
    ...
    def add_scaler(self, key: str, scaler: Union[Scaler, ScalerModule]):
        r"""Add a :class:`tsl1.data.preprocessing.Scaler` for the object indexed
        ...
        Args:
            ...
            scaler (Scaler): The :class:`~tsl1.data.preprocessing.Scaler`.
        """
        if key not in self.keys:
            raise KeyError(f"{key} not in {self.name}.")
    ...
    def from_dataset(cls,
        ...
        """Create a :class:`~tsl1.data.SpatioTemporalDataset` from a
        :class:`~tsl1.datasets.prototypes.TabularDataset`.
        """
