...
class SpatioTemporalDataModule(LightningDataModule):
    ...
    Args:
        ...
        scalers (dict, optional): Named mapping of
            :class:`~tsl1.data.preprocessing.scalers.Scaler`
        ...
        splitter (Splitter, optional): The
            :class:`~tsl1.data.datamodule.splitters.Splitter` to be used for
        ...
        pin_memory (bool): If :obj:`True`, then enable pinned GPU memory for
            :meth:`~tsl1.data.datamodule.SpatioTemporalDataModule.train_dataloader`.
            (default :obj:`False`)
    """
