...
class CustomSplitter(Splitter):
    r"""Create a :class:`~tsl1.data.datamodule.splitters.Splitter` using custom
...
class FixedIndicesSplitter(Splitter):
    r"""Create a :class:`~tsl1.data.datamodule.splitters.Splitter` using fixed
...
class AtTimeStepSplitter(Splitter):
    ...
    :class:`~tsl1.data.SpatioTemporalDataset` with
