...
class Predictor(pl.LightningModule):
    ...
    def predict_batch(self,
                      ...
                      **forward_kwargs):
        """This method takes as input a :class:`~tsl1.data.Data` object and
        outputs the predictions.

        Note that this method works seamlessly for all :class:`~tsl1.data.Data`
        subclasses like :class:`~tsl1.data.StaticBatch` and
        :class:`~tsl1.data.DisjointBatch`.
