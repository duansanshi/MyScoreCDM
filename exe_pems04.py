...
from main_model_aqi36 import Score_Pems04
...
def main(args):
    ...
    foldername = (
        "./save/pems04_" + args.missing_pattern + '_' + current_time + "/"
    )
    ...
    model = Score_Pems04(config, args.device).to(args.device)
    ...
    #model.load_state_dict(torch.load("/home/duanlei/Score-CDM/save/pems04_point_20251211_013958/model.pth")) #11.5 use guide false
    model.load_state_dict(torch.load("/home/duanlei/Score-CDM/save/pems04_point_20251211_014100/model.pth")) #11.1 use guide true
